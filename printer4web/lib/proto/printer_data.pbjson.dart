...
const ChangeTempControl$json = const {
  ...
  '2': const [
    ...
    const {'1': 'selected_print_config', '3': 2, '4': 1, '5': 11, '6': '.Printer.PrintConfig', '10': 'selectedPrintConfig'},
  ],
};

/// Descriptor for `ChangeTempControl`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List changeTempControlDescriptor = $convert.base64Decode('ChFDaGFuZ2VUZW1wQ29udHJvbBIbCglpc19hY3RpdmUYASABKAhSCGlzQWN0aXZlEkgKFXNlbGVjdGVkX3ByaW50X2NvbmZpZxgCIAEoCzIULlByaW50ZXIuUHJpbnRDb25maWdSE3NlbGVjdGVkUHJpbnRDb25maWc=');
...
const PrinterStatus$json = const {
  ...
  '2': const [
    ...
    const {'1': 'fan_speed', '3': 7, '4': 1, '5': 2, '10': 'fanSpeed'},
  ],
};

/// Descriptor for `PrinterStatus`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List printerStatusDescriptor = $convert.base64Decode('');
